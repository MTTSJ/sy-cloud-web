...
export function sysRoleOwnMenu(parameter) {
  return axios({
    url: '/mate-system/role/role-menu',
    method: 'get',
    params: parameter,
  });
}
...
export function sysRoleGrantMenu(parameter) {
  return axios({
    url: '/mate-system/role/set-grant-menu',
    method: 'post',
    data: parameter,
  });
}
...
export function sysRoleOwnData(parameter) {
  return axios({
    url: '/mate-system/role/get-data-scope',
    method: 'get',
    params: parameter,
  });
}
...
export function sysRoleGrantData(parameter) {
  return axios({
    url: '/mate-system/role/set-data-scope',
    method: 'post',
    data: parameter,
  });
}
