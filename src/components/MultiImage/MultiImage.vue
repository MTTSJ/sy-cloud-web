<template>
    <div class="image-list clearfix" :class="{ multiple }">
            ...
            <transition-group type="transition" :name="'flip-list'">
                ...
                >
                    ...
                    <a :href="item.url" target="_blank">
                        <div class="img-cover" :style="{ backgroundImage: `url('${item.thumbUrl}')` }"></div>
                    </a>
                    <!-- 删除文件 -->
        ...
        <material-use
            ...
            modal
            size="middle"
            :active-categories="['image']"
            :select-mode="multiValue"
            @confirm="handleSelectImageSubmit"
        />
    </div>
</template>
...
<script>
    ...
    import { MaterialUse } from '@/components/MaterialManager';
    ...
    export default {
        ...
        methods: {
            ...
            handleSelectImage() {
                ...
                this.multiValue = this.multiple ? 'multi' : 'radio';
                this.visible = true;
            },
            ...
            onChange() {
                ...
                // 生成fileId
                const fileId = selectedItems.map(item => item.id);
                this.visible = false;
                // 触发change事件
