    ...
    >
        <div class="setting-drawer-index-content">
            <div :style="{ marginBottom: '24px' }">
                ...
                <div class="setting-drawer-index-blockChecbox">
                    <a-tooltip>
                        ...
                        >
                            <img src="@/assets/style-dark.svg" alt="dark" />
                            <div
                    ...
                    <a-tooltip>
                        ...
                        >
                            <img src="@/assets/style-light.svg" alt="light" />
                            <div
                                class="setting-drawer-index-selectIcon"
                                v-if="navTheme !== 'dark'"
                            >
            ...
            <div :style="{ marginBottom: '24px' }">
                ...
                <div class="setting-drawer-index-blockChecbox">
                    <a-tooltip title="分栏导航">
                        <div
                            class="setting-drawer-index-item"
                            @click="handleLayout('splitmenu')"
                        >
                            <img src="@/assets/split-layout.png" alt="splitmenu" />
                            <div
                                class="setting-drawer-index-selectIcon"
                                v-if="layoutMode === 'splitmenu'"
                            >
                                <a-icon type="check" />
                            </div>
                        </div>
                    ...
                    <a-tooltip>
                        ...
                        >
                            <img src="@/assets/side-nav.svg" alt="sidemenu" />
                            <div
                                class="setting-drawer-index-selectIcon"
                    ...
                    <a-tooltip>
                        ...
                        >
                            <img src="@/assets/head-nav.svg" alt="topmenu" />
                            <div
                                class="setting-drawer-index-selectIcon"
                    ...
                    <a-tooltip>
                        <template slot="title">混合导航</template>
                        <div
                            class="setting-drawer-index-item"
                            @click="handleLayout('mixmenu')"
                        >
                            <img src="@/assets/mix-nav.svg" alt="mixmenu" />
                            <div
                                class="setting-drawer-index-selectIcon"
                                v-if="layoutMode === 'mixmenu'"
                            >
                                <a-icon type="check" />
                            </div>
                        </div>
                    ...
                    <a-list :split="false">
                        ...
                        <a-list-item>
                            <a-switch
                                slot="actions"
                                size="small"
                                :defaultChecked="colorGray"
                                @change="onColorGray"
                            />
                            <a-list-item-meta>
                                <div slot="title">灰度模式</div>
                            </a-list-item-meta>
                        </a-list-item>
                        <a-list-item>
                            <a-switch
...
<script>
    ...
    import { updateTheme, updateColorWeak, updateColorGray, colorList } from './settingConfig';
    ...
    export default {
        ...
        data() {
            return {
                drawerEnabled: config.showDrawer,
                visible: false,
                colorList,
            };
        },
