<template>
    <div>
        <a-modal
            ...
            @ok="save"
        >
            <a-alert style="margin-bottom: 24px" >
            ...
            >
                ...
                <a-form-item prop="elementVariable">
                    <template slot="label">
                        <a-tooltip>
                            <template slot="title">
                ...
                <a-form-item prop="completionCondition"
                >
                    <template slot="label">
                        <a-tooltip>
                            <template slot="title">
