...
<template>
    ...
    >
        ...
        <!-- 日期选择 -->
        <KDatePicker v-else-if="record.type === 'date'" :parentDisabled="parentDisabled" :record="record" :value="value" @change="handleChange" />
        <!-- 时间选择 -->
        <KTimePicker v-else-if="record.type === 'time'" :parentDisabled="parentDisabled" :record="record" :value="value" @change="handleChange" />
        <!-- 数字输入框 -->
        <a-input-number
        ...
        />
        <!-- 开关 -->
        <a-switch v-else-if="record.type === 'switch'" :disabled="record.options.disabled || parentDisabled" :checked="value" @change="handleChange" />
        <!-- 滑块 -->
