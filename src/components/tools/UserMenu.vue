<template>
    <div class="user-wrapper">
        <div class="content-box">
            <div class="action" @click="$refs.routeSearch.show()">
                <a-icon type="search"/>
                <MenuSearch ref="routeSearch"/>
            </div>

            <!--<div class="action" @click="$refs.business.show()">
        <span :style="{ fontSize: '16px', color: 'red' }">
          ...
          <Business ref="business"/>
            ...
            <div class="action" @click="onFullscreen(fullscreen ? 'exit' : 'enter')">
            ...
            <a-dropdown>
                ...
                <a-menu slot="overlay" class="user-dropdown-menu-wrapper">
                    <a-menu-item key="4" v-if="isMobile()">
                        <a @click="appToggled()">
                            <a-icon type="swap"/>
                            <span>切换应用</span>
                        </a>
            ...
            <a class="action" @click.prevent="$refs.settingDrawer.toggle()">
                <a-icon type="setting"/>
...
<script>
    ...
    import MenuSearch from '@/components/tools/MenuSearch';
