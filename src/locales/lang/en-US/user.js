export default {
  ...
  'user.login.password.placeholder': 'password: sycloud123',
  ...
  'user.login.message-require-credentials': 'Please enter the account',
  'user.login.message-require-password': 'Please enter password',
  'user.login.message-require-captcha': 'Please enter the captcha',
  'user.login.message-invalid-verification-code': 'Invalid verification code',
  'user.login.tab-login-credentials': 'Credentials',
  'user.login.tab-login-mobile': 'Mobile',
  'user.login.mobile.placeholder': 'Mobile number',
  'user.login.mobile-invalid': 'Please enter the correct mobile number',
  'user.login.mobile.verification-code.placeholder': 'Verification code',
  'user.login.verification-code-invalid': 'Please enter the verification code',
  'user.login.tab-login-wx': 'Weixin',
