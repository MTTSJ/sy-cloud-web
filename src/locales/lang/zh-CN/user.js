export default {
  ...
  'user.login.username.placeholder': '账号: admin',
  'user.login.password.placeholder': '密码: sycloud123',
  'user.login.captcha.placeholder': '验证码',
  'user.login.message-invalid-credentials': '账户或密码错误（admin/ant.design）',
  'user.login.message-require-credentials': '请输入帐号',
  'user.login.message-require-password': '请输入密码',
  'user.login.message-require-captcha': '请输入验证码',
  'user.login.message-invalid-verification-code': '验证码错误',
  'user.login.tab-login-credentials': '账户密码',
  'user.login.tab-login-mobile': '手机号',
  'user.login.mobile.placeholder': '手机号',
  'user.login.mobile-invalid': '请输入正确的手机号',
  'user.login.mobile.verification-code.placeholder': '验证码',
  'user.login.verification-code-invalid': '请输入验证码',
