export default {
  ...
  'user.login.username.placeholder': '賬號: admin',
  'user.login.password.placeholder': '密碼: sycloud123',
  'user.login.captcha.placeholder': '驗證碼',
  'user.login.message-invalid-credentials': '賬戶或密碼錯誤（admin/ant.design）',
  'user.login.message-require-credentials': '請輸入帳號',
  'user.login.message-require-password': '請輸入密碼',
  'user.login.message-require-captcha': '請輸入驗證碼',
  'user.login.message-invalid-verification-code': '驗證碼錯誤',
  'user.login.tab-login-credentials': '賬戶密碼',
  'user.login.tab-login-mobile': '手機號',
  'user.login.mobile.placeholder': '手機號',
  'user.login.mobile-invalid': '請輸入正確的手機號',
  'user.login.mobile.verification-code.placeholder': '驗證碼',
  'user.login.verification-code-invalid': '請輸入驗證碼',
  'user.login.tab-login-wx': '微信',
