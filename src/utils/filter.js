...
Vue.filter('dictType', function(code, value) {
  ...
  // eslint-disable-next-line eqeqeq
  const values = tree.filter(item => item.dictKey == value);
...
Vue.filter('dictDataAll', function() {
  console.log('====mateP====filter.js 97');
  console.log(Vue.ls.get(DICT_TYPE_TREE_DATA));
  console.log('====mateP====filter.js 99');
