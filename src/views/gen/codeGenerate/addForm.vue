                        ...
                        >
                            <a-radio-group
                                v-decorator="[
                                    'tablePrefix',
                                    {
                                        rules: [{ required: true, message: '请选择是否移除前缀！' }]
                                    }
                                ]"
                            >
                                <a-radio
                                    v-for="(item, index) in tablePrefixData"
                                    :key="index"
                                    :value="item.code"
                                    @click="tablePrefixRadio(item.code)"
                                >
                                    {{ item.name }}
                                </a-radio>
                            </a-radio-group>
                    ...
                    <a-col :md="12" :sm="24" v-show="packageNameShow">
                        ...
                        >
                            <a-input
                                ...
                                v-decorator="[
                                    'packageName',
                                    { rules: [{ required: true, message: '请输入代码包名！' }] }
                                ]"
                            />
                        </a-form-item>
                    </a-col>
...
<script>
    ...
    export default {
        ...
        methods: {
             ...
             */
            selectedByDefault() {
                this.form.getFieldDecorator('packageName', { initialValue: 'vip.mate' });
                this.form.getFieldDecorator('tablePrefix', {
            ...
            dataTypeItem() {
                ...
                this.generateTypeData = this.$options.filters['dictData'](
            ...
            settingDefaultValue() {
                ...
                this.form.getFieldDecorator('busName', {
                    initialValue: tableName.toLowerCase(),
                });
            },
            /**
             * 设置类名为数据库表的驼峰命名
            ...
            generateTypeRadio(generateType) {
                if (generateType === '1') {
                    ...
                    this.form.setFieldsValue({ packageName: 'vip.mate' });
                }
            },
        },
    };
