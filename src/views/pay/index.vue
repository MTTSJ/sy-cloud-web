                ...
                <slot slot="pageMenu">
                            ...
                            <a-card :bordered="false" style="background-color: #fafafa">
                                <div class="desc">
                                    <div style="margin-bottom: 16px">
                                        沙箱环境支付宝下载（仅支持安卓）：
                                        <a
                                            href="https://sandbox.alipaydev.com/user/downloadApp.htm"
                                            target="_blank"
                                        >
                                            点我下载
                                        </a>
                                    ...
                                    <div style="margin-bottom: 16px">
                                        ...
                                        <span style="margin-left: 16px">
                                            商户账号：wkcmti6320@sandbox.com
                                        </span>
                                        <span style="margin-left: 16px">
                                            商户UID：2088621955163903
                                        </span>
                                    </div>
                                    <div style="margin-bottom: 16px">
                                        买家信息：
                                        <span style="margin-left: 16px">
                                            买家账号：uvvjvx5395@sandbox.com
                                        </span>
                    ...
                    "
                                    ...
                                    <div style="margin-bottom: 16px">
                                        <a-icon
                                            type="check-circle"
                                            style="color: #0bbe18; margin-right: 8px"
                                        />
                                        PC支付
                                        <a
                                            style="margin-left: 16px"
                                            @click="openPayInPrice('pcAliPay')"
                                        >
                                            立即体验
                                            <a-icon type="right" />
                                        </a>
                                    ...
                                    <div style="margin-bottom: 16px">
                                        ...
                                        <a
                                            style="margin-left: 16px"
                                            @click="openPayInPrice('wapAliPay')"
                                        >
                                            立即体验
                                            <a-icon type="right" />
                                        </a>
                                    ...
                                    <div style="margin-bottom: 20px">
                                        ...
                                        <a
                                            style="margin-left: 16px"
                                            @click="openPayInPrice('tradePreCreateAliPay')"
                                        >
                                            立即体验
                                            <a-icon type="right" />
                                        </a>
            ...
            >
                <a-spin :spinning="spinloading">
                    <a-form :form="form" v-show="formShow">
                        <a-form-item label="支付金额" has-feedback>
                            <a-input-number
                                placeholder="请输入请输入支付金额（最少0.01元）"
                                style="width: 100%"
                                v-decorator="[
                                    'amount',
                                    {
                    ...
                    <div style="text-align: center" v-show="aliPayQrPriceShow">
                        ...
                        <div>
                            <span>
                                请使用支付宝扫码，您需要支付：{{ this.aliPayQrPrice }}元
                            </span>
                        </div>
                    </div>
                </a-spin>
        ...
        methods: {
            ...
            pcAliPay(values) {
                getOutTradeNo().then((res) => {
                    if (res.success) {
                        ...
                        window.open(baseURL + '/aliPay/pcPay?amount=' + values.amount + '&outTradeNo=' + res.data, '_blank');
                        this.handleCancel();
            ...
            wapAliPay(values) {
                getOutTradeNo().then((res) => {
                    if (res.success) {
                        this.outTradeNo = res.data;
                        window.open(baseURL + '/aliPay/wapPay?amount=' + values.amount + '&outTradeNo=' + res.data, '_blank');
                        this.handleCancel();
                        this.showConfirm(this.outTradeNo, this.$message);
                    } else {
            ...
            tradePreCreateAliPay(values) {
                ...
                this.aliPayQrSrc = baseURL + '/aliPay/tradePreCreatePay?amount=' + values.amount;
                this.imgInit();
            },
            /**
             * 加载二维码loading
