        ...
        <a-spin :spinning="formLoading">
            <a-form :form="form">
                        ...
                        <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="菜单层级">
                            <a-radio-group v-decorator="['type', { rules: [{ required: true, message: '请选择菜单层级！' }] }]">
                                <a-radio
                                    ...
                                    :key="index"
                                    :value="item.dictKey"
                                    @click="meneTypeFunc(item.dictKey)"
                                >
                                    {{ item.dictValue }}
                                </a-radio>
                            </a-radio-group>
                        ...
                        <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol">
                            ...
                            >
                                <a-radio
                                    ...
                                    :key="index"
                                    :value="item.dictKey"
                                    @click="meneOpenTypeFunc(item.dictKey)"
                                >
                                    {{ item.dictValue }}
                                </a-radio>
                            </a-radio-group>
                            ...
                            <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" hasFeedback>
                                ...
                                <a-input
                                    ...
                                    v-decorator="[
                                        'router',
                                        {
                                            rules: [{ required: routerRequired, message: '请输入路由！' }]
                                        }
                                    ]"
                                />
                            </a-form-item>
                ...
                <a-row :gutter="24">
                    <a-col :md="12" :sm="24">
                        <div v-show="linkShow">
                            <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" hasFeedback>
                                <span slot="label">
                                    <a-tooltip title="当选择了需要内链或外链打开的选项，此处输入要打开的链接地址，例：https://mate.vip">
                                        <a-icon type="question-circle-o" />
                                    </a-tooltip>
                                    &nbsp; 内外链地址
                                </span>
                                <a-input
                                    ...
                                    v-decorator="[
                                        'link',
                                        {
                                            rules: [{ required: linkRequired, message: '请输入权限标识！' }]
                                        }
                                    ]"
                                />
                            </a-form-item>
                    ...
                    <a-col :md="12" :sm="24">
                        <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol">
                            ...
                            <a-radio-group v-decorator="['weight']">
                                <a-radio v-for="(item, index) in weightData" :key="index" :value="item.dictKey">
                                    {{ item.dictValue }}
                                </a-radio>
                            </a-radio-group>
                        </a-form-item>
                ...
                <a-row :gutter="24">
                    ...
                    <div v-show="badgeShow">
                        <a-col :md="12" :sm="24">
                            <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="徽标" hasFeedback>
                                <a-input
                                    placeholder="请输入徽标,dot表示圆点，其他字符直接显示"
                                    v-decorator="[
                                        'badge',
                                        {
                                            rules: [{ required: false, min: 1, max: 4, message: '长度不要超过4字符！' }]
                                        }
                                    ]"
                                />
                            </a-form-item>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            sysDictTypeDropDown() {
                // 菜单类型
                this.typeData = this.$options.filters['dictData']('menuType');
                // 权重
                this.weightData = this.$options.filters['dictData']('menuWeight');
                // 内外链
                this.openTypeData = this.$options.filters['dictData']('openType');
